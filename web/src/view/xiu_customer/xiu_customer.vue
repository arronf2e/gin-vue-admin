  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">      
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增客户表</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="客户名称" prop="name" width="120"></el-table-column> 
    
    <el-table-column label="车牌号" prop="licensePlate" width="120"></el-table-column> 
    
    <el-table-column label="联系方式" prop="contact" width="120"></el-table-column> 
    
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button class="table-button" @click="updateCustomer(scope.row)" size="small" type="primary" icon="el-icon-edit">变更</el-button>
